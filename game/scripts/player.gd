...
## C07/C08/C09: velocity is units/second, not displacement per frame.
...
func _enter_tree() -> void:
	# F6 also works without a separate bootstrap scene.
	# Preserve actions the learner has already configured in Project Settings.
	var bindings := {
