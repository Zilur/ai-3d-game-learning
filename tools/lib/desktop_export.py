...
def main():
    ...
    p.add_argument('--out', type=Path, default=Path('dist/desktop'))
    a = p.parse_args()
    system = platform.system()
    preset, filename = release_target(system)
    license_path = ROOT / 'practice/godot/assets/village/LICENSE.txt'
    ...
    base = [a.godot, '--headless', '--audio-driver', 'Dummy', '--path', str(ROOT / 'practice/godot')]
    ...
    shutil.copy2(ROOT / 'practice/godot/assets/practice-asset-notes.md', package / 'PRACTICE-ASSET-NOTES.md')
