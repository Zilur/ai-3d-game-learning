...
原PR #2提交a8e2c166949d7d1dd021303dc2476f5acd1d2136曾通过Godot4.7.2导入及50项无界面行为测试。当前整合以c06a0db763ab3c32d7200ce6c7ae51af41b957a2的工程为基础，保留原PR #1双球实验并新增A03，必须重新测试。

[当前工作流运行列表](https://github.com/Zilur/ai-3d-game-learning/actions/workflows/validate.yml) 的绿色结果对应具体提交；查看日志中的COURSE VALIDATION PASS、SMOKE PASS与A03 PASS。添加工作流文件不是通过证据。

|层次|检查内容|边界|
|---|---|---|
|课程静态检查|Markdown文件链接、32概念/64P-T题与答案、单一目录/评分、A03材料入口|不证明所有教学事实正确或学员已掌握|
...
|A03|三个场景加载、实例/职责、整体移动、故障修复、外观替换|测试提供的参考解，不读取/评分个人作业|
...
- [ ] A03在实际窗口可看清两个模块，Camera正确，字体/标牌/子节点操作无障碍。
