...
## OpenMAIC负责课堂，本地伴侣负责学习接续

OpenMAIC有作答/讨论/PBL过程记录，也有学习方法技能；我们不是只准备交互页。但两边尚未自动同步：课后观察需成人核对写回本地，复习队列才会更新。默认教师输入不含孩子历史；可选私人学情附件由`tools/openmaic_handoff.py`先预览、确认后导出，不上传。见[核查与具体用法](openmaic/capability-audit.md)。
